...
@Composable
fun WeatherIcon(modifier: Modifier = Modifier, name: String, dayTime: String) {
    Image(
        modifier = modifier,
        painter = painterResource(id = name.mapToDrawableRes(dayTime)),
        contentDescription = "$name-$dayTime"
    )
}

@Composable
fun WeatherIcon(modifier: Modifier = Modifier, name: String, time: Int) {
    Image(
        modifier = modifier,
        painter = painterResource(id = name.mapToDrawableRes(time)),
