...
@Composable
fun GlanceWeatherIcon(modifier: GlanceModifier = GlanceModifier, name: String, dayTime: String) {
    Image(
        modifier = modifier,
...
@Composable
fun GlanceWeatherIcon(modifier: GlanceModifier = GlanceModifier, name: String, time: Int) {
    Image(
        modifier = modifier,
